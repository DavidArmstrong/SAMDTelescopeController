/* Arduino SAMD-based Telescope Controller 4.00.00 Diagnostics - February 2026
...
// Comment out if not using old HMC6352 magnetic compass
//#define __HMC6352__
...
const int SPI_SS2 = 9; // D9 - telescope tube Altitude inclinometer sensor select
...
//============================
// Hardware/Software Declarations
...
void setup() {
  ...
  Serial.begin(9600); //May use VT100 compatible terminal emulator
  while (!Serial && !Serial2); //Wait for user to open terminal
  newdelay(2000);
  TERMclear();
  TCterminal.println(" Telescope Controller 4.0 Hardware Diagnostics Sketch.");
  TCterminal.println(" Required Arduino Libraries are installed successfully\n");
  
  
  // Test 1A - Terminal outputs
  TCterminal.println(" Start with Test of Serial Output. ( Which you see here. )");
  TCterminal.println(" Default USB Serial Interface is working\n");
  TCterminal.println(" Initialize I2C.\n");
  Wire.begin(); // I2C init
  TCterminal.println(" Initialize Serial1 for LCD 4x20 char display.\n");
  Serial1.begin(9600); // serial 4x20 LCD display

  // For SAMD51 Serial2
  TCterminal.println(" Initialize Serial2 for XeeBee interface.\n");
  ...
  TCterminal.println(" Initialize limits and pushbutton inputs.\n");
  ...
  Serial2.println("Telescope Controller 4.0 Diagnostics Sketch - XeeBee");
  ...
  // Test 4 - EEPROM detect - verify presence of I2C EEPROM
  ...
  // Test 5 - u-blox GPS detection
  TCterminal.print("u-blox GPS module ");
  Serial2.print("u-blox GPS module ");
  ...
  // Test 6 - Leveling Murata SCL3300 Inclinometer Sensor detection
  TCterminal.print("Rocker (Leveling) Murata SCL3300 inclinometer ");
  Serial2.print("Rocker (Leveling) Murata SCL3300 inclinometer ");
  ...
  // Test 7 - Altitude Murata SCL3300 Inclinometer Sensor detection
  TCterminal.print("Tube (Altitude) Murata SCL3300 inclinometer ");
  Serial2.print("Tube (Altitude) Murata SCL3300 inclinometer ");
  ...
  if (FMAGHDG > 360.1) { //Old Magnetic Compass not detected at default I2C address
    ...
    if (dobHMC6343.init()) {
      ...
      TCterminal.println("HMC6343 Magnetic Compass detection failed.");
      Serial2.println("HMC6343 Magnetic Compass detection failed.");
	}
#endif
    TCterminal.print("MMC5983MA Magnetic Compass ");
    Serial2.print("MMC5983MA Magnetic Compass ");
  ...
  // Test 9 - BME280 Temperature, Pressure,Humidity Sensor detection
  ...
  // Test 10 - Azimuth Reference Sensor Detection
  ...
  // Test 11 - Lock/Reinitialize Switch Detection
  ...
  // Test 12 - Motor Driver Board detection and Motor test
  ...
  // Test 13 - IR Remote Receiver functionality check
  long xn;
